...
::: {Important}
This example uses `test1`, `test2`, `test3` keys from [LocalPaloma](https://github.com/Paloma-money/LocalPaloma). Import them into your `Palomad` keystore to follow along.
:::
...
Send 5 LUNA from your multisig account to `Paloma1fmcjjt6yc9wqup2r06urnrd928jhrde6gcld6n`.
...
Palomad tx multisign \
    ...
    --chain-id=localPaloma > signedTx.json
```
